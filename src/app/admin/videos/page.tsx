                ...
                <TableRow key={video.id}>
                  ...
                  <TableCell>
                    {video.status === "published" ? (
                      ...
                      <Badge className="bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300">Unapproved</Badge>
                    )}
                  </TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">{video.status}</Badge>
